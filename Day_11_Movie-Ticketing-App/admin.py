...
class Admin:
    def __init__(self):
        ...
        self.tickets = data.to_dict('ID')[0]
        print(self.tickets)
    ...
    def _load_tickets_from_csv(self):
        ...
        with open('tickets.csv', mode='r') as file:
            ...
            for row in reader:
                tickets[row['ID']] = {'movie_name': row['Movie Name'], 'timing': row['Timing'], 'seat': row['Seat']}
        

    def add_movie(self, name, duration, cinema_number,timings = ['10:00', '13:00', '16:00', '19:00', '22:00', '01:00']):
